 ...
 * not just the previous node. Now write a program in O(n) time
 * to duplicate this list. That is, write a program which will create
 * a copy of this list.
 *
...
void _7_clone_linked_list_with_random_pointer()
{
